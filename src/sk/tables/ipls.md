# Chýbajúce interiéry - IPL-ka (Missing Interiors IPLs)

Toto je prevzaté z [Dzeknjak-ových Missing Interiors](https://github.com/jovanivanovic/altv-os-missing-interiors/).

Bude to opravovať otvory, medzery a chýbajúce interiéry pre GTA:V.

Musia byť načítané **na strane klienta**.
